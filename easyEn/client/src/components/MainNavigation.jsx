...
export default function MainNavigation({ isCollapsed, toggleMenu }) {
  const icons = {
    '/': (
    <span>
      <svg width="22" height="22" viewBox="0 0 18 20" fill="currenColor" xmlns="http://www.w3.org/2000/svg">
